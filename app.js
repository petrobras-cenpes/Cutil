...
// Lista central dos filtros existentes — usada tanto para popular os selects
// quanto para redefini-los ao clicar em "Limpar".
const FILTER_IDS = ["f_painel", "f_area", "f_funcao", "f_tensao", "f_grau"];
...
async function init(){
  try {
    ...
    fillSelect("f_painel", uniqueSorted(DATA.map(x => x.painel)));
    ...
    // Botão "Limpar": zera o texto de busca E todos os filtros (volta para "todos"/"todas")
